<!-- generated by iii-skill-render. DO NOT EDIT (changes here are overwritten on the next render). Edit docs/0-12-0/tutorials/incremental-adoption/overview.mdx. -->
